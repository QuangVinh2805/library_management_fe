...
@Component({
  selector: 'app-product-psychology-carousel',
  imports: [NgForOf, NgIf],
  templateUrl: './product-psychology-carousel.html',
  styleUrl: './product-psychology-carousel.css',
})
export class ProductPsychologyCarousel implements OnInit {
  ...
  triggerAnimation() {
    const el = document.querySelector('#psychologyBooksCarousel') as HTMLElement;
    if (!el) return;
