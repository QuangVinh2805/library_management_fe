...
import {ProductCategoryCarousel} from '../product-category-carousel/product-category-carousel';
import {ProductPsychologyCarousel} from '../product-psychology-carousel/product-psychology-carousel';
import {Banner} from '../banner/banner';
import {Router} from '@angular/router';
import {ProductFavouriteCarousel} from '../product-favourite-carousel/product-favourite-carousel';
import {ProductBorrowCarousel} from '../product-borrow-carousel/product-borrow-carousel';

@Component({
  selector: 'app-product',
  standalone: true,
  imports: [NgForOf, NgIf, ProductCategoryCarousel, ProductPsychologyCarousel, Banner, ProductFavouriteCarousel, ProductBorrowCarousel],
...
export class Product implements OnInit {
  ...
  loadBooks() {
    this.loading = true;
    this.productService.getAllNewProduct().subscribe({
      next: (res) => {
        this.books = res.data || [];
  ...
  triggerAnimation() {
    const el = document.querySelector('#newBooksCarousel') as HTMLElement;
    if (!el) return;
